...
namespace HSExtSave
{
    public class HSExtSave : IPlugin
    {
        ...
        public delegate void ExtSaveCharWriteHandler(ChaFileControl charFile, XmlTextWriter writer);
        ...
        public delegate void ExtSaveClothesReadHandler(ChaFileClothes clothesInfo, XmlNode node);
        public delegate void ExtSaveClothesWriteHandler(ChaFileClothes clothesInfo, XmlTextWriter writer);
        #endregion
        ...
        {
            UnityEngine.Debug.LogError("HSExtSave.OnApplicationStart "+ Process.GetCurrentProcess().ProcessName);
            ...
            Harmony.CreateAndPatchAll(Assembly.GetExecutingAssembly(), "com.joan6694.hsplugins.charextsave");
        }
