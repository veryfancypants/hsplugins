...
def gen_header_bonepos(x, y, z):
	return '<interpolable enabled="true" owner="AIPE" objectIndex="' + str(x) + '" id="' + z + '" parameter="' + y + '" bgColorR="1" bgColorG="1" bgColorB="1" alias="">'
...
# Reference walking animation ("Walking 1") for a large male (see reference_dim above). 
positions={
('f_t_hips(work)', 0) : [0.018, 10.607, 0.310],
('f_t_hips(work)', 1) : [0.017, 10.588, 0.318],
('f_t_hips(work)', 9) : [0.029, 10.252, 0.367],
('f_t_hips(work)', 11) : [0.031, 10.184, 0.368],
('f_t_hips(work)', 17) : [0.001, 10.316, 0.330],
('f_t_hips(work)', 18) : [-0.003, 10.358, 0.322],
('f_t_hips(work)', 27) : [0.009, 10.631, 0.278],
('f_t_hips(work)', 37) : [0.029, 10.366, 0.338],
('f_t_hips(work)', 42) : [0.035, 10.179, 0.342],
('f_t_hips(work)', 46) : [0.053, 10.181, 0.318],
('f_t_hips(work)', 52) : [0.065, 10.436, 0.285],
('f_t_shoulder_L(work)', 0) : [-1.329, 13.708, 0.250],
('f_t_shoulder_L(work)', 1) : [-1.340, 13.686, 0.271],
('f_t_shoulder_L(work)', 9) : [-1.371, 13.339, 0.298],
('f_t_shoulder_L(work)', 11) : [-1.367, 13.272, 0.275],
('f_t_shoulder_L(work)', 17) : [-1.325, 13.419, 0.090],
('f_t_shoulder_L(work)', 18) : [-1.319, 13.463, 0.069],
('f_t_shoulder_L(work)', 27) : [-1.259, 13.759, 0.086],
('f_t_shoulder_L(work)', 37) : [-1.197, 13.509, 0.115],
('f_t_shoulder_L(work)', 42) : [-1.176, 13.311, 0.055],
('f_t_shoulder_L(work)', 46) : [-1.167, 13.301, -0.033],
('f_t_shoulder_L(work)', 52) : [-1.197, 13.535, -0.032],
('f_t_elbo_L(work)', 0) : [-1.914, 11.241, 0.267],
('f_t_elbo_L(work)', 1) : [-1.923, 11.221, 0.368],
('f_t_elbo_L(work)', 9) : [-1.961, 10.900, 0.657],
('f_t_elbo_L(work)', 11) : [-1.967, 10.831, 0.601],
('f_t_elbo_L(work)', 17) : [-1.927, 10.956, 0.074],
('f_t_elbo_L(work)', 18) : [-1.914, 11.000, 0.010],
('f_t_elbo_L(work)', 27) : [-1.822, 11.363, -0.521],
('f_t_elbo_L(work)', 37) : [-1.835, 11.194, -0.697],
('f_t_elbo_L(work)', 42) : [-1.821, 10.989, -0.731],
('f_t_elbo_L(work)', 46) : [-1.798, 10.936, -0.692],
('f_t_elbo_L(work)', 52) : [-1.799, 11.113, -0.482],
('f_t_arm_L(work)', 0) : [-2.461, 9.418, 1.333],
('f_t_arm_L(work)', 1) : [-2.474, 9.416, 1.462],
('f_t_arm_L(work)', 9) : [-2.544, 9.139, 1.805],
('f_t_arm_L(work)', 11) : [-2.560, 9.030, 1.680],
('f_t_arm_L(work)', 17) : [-2.487, 8.916, 0.606],
('f_t_arm_L(work)', 18) : [-2.459, 8.937, 0.464],
('f_t_arm_L(work)', 27) : [-2.318, 9.241, -0.614],
('f_t_arm_L(work)', 37) : [-2.409, 9.103, -0.931],
('f_t_arm_L(work)', 42) : [-2.399, 8.889, -0.843],
('f_t_arm_L(work)', 46) : [-2.352, 8.827, -0.638],
('f_t_arm_L(work)', 52) : [-2.312, 9.026, -0.112],
('f_t_thigh_L(work)', 0) : [-0.820, 9.098, 0.027],
('f_t_thigh_L(work)', 1) : [-0.820, 9.081, 0.024],
('f_t_thigh_L(work)', 9) : [-0.817, 8.773, -0.025],
('f_t_thigh_L(work)', 11) : [-0.817, 8.708, -0.037],
('f_t_thigh_L(work)', 17) : [-0.819, 8.818, -0.045],
('f_t_thigh_L(work)', 18) : [-0.820, 8.854, -0.040],
('f_t_thigh_L(work)', 27) : [-0.820, 9.111, 0.029],
('f_t_thigh_L(work)', 37) : [-0.820, 8.860, 0.076],
('f_t_thigh_L(work)', 42) : [-0.818, 8.676, 0.074],
('f_t_thigh_L(work)', 46) : [-0.818, 8.687, 0.054],
('f_t_thigh_L(work)', 52) : [-0.818, 8.947, 0.035],
('f_t_knee_L(work)', 0) : [-0.483, 5.110, 0.383],
('f_t_knee_L(work)', 1) : [-0.509, 5.084, 0.293],
('f_t_knee_L(work)', 9) : [-0.585, 4.782, -0.429],
('f_t_knee_L(work)', 11) : [-0.587, 4.751, -0.692],
('f_t_knee_L(work)', 17) : [-0.665, 4.987, -1.247],
('f_t_knee_L(work)', 18) : [-0.700, 4.978, -1.092],
('f_t_knee_L(work)', 27) : [-0.784, 5.554, 1.897],
('f_t_knee_L(work)', 37) : [-0.570, 5.602, 2.415],
('f_t_knee_L(work)', 42) : [-0.544, 5.281, 2.205],
('f_t_knee_L(work)', 46) : [-0.505, 5.191, 2.011],
('f_t_knee_L(work)', 52) : [-0.479, 5.229, 1.521],
('f_t_leg_L(work)', 0) : [-0.076, 0.784, -0.695],
('f_t_leg_L(work)', 1) : [-0.080, 0.783, -0.872],
('f_t_leg_L(work)', 9) : [-0.111, 0.787, -2.393],
('f_t_leg_L(work)', 11) : [-0.120, 0.828, -2.798],
('f_t_leg_L(work)', 17) : [-0.259, 1.527, -4.058],
('f_t_leg_L(work)', 18) : [-0.309, 1.665, -4.077],
('f_t_leg_L(work)', 27) : [-1.041, 2.305, -1.172],
('f_t_leg_L(work)', 37) : [-0.599, 1.193, 3.188],
('f_t_leg_L(work)', 42) : [-0.283, 1.015, 3.539],
('f_t_leg_L(work)', 46) : [-0.123, 0.777, 2.651],
('f_t_leg_L(work)', 52) : [-0.050, 0.780, 1.267],
('f_t_shoulder_R(work)', 0) : [1.294, 13.839, 0.063],
('f_t_shoulder_R(work)', 1) : [1.283, 13.826, 0.081],
('f_t_shoulder_R(work)', 9) : [1.253, 13.498, 0.144],
('f_t_shoulder_R(work)', 11) : [1.258, 13.422, 0.127],
('f_t_shoulder_R(work)', 17) : [1.304, 13.522, 0.015],
('f_t_shoulder_R(work)', 18) : [1.311, 13.559, 0.014],
('f_t_shoulder_R(work)', 27) : [1.372, 13.827, 0.153],
('f_t_shoulder_R(work)', 37) : [1.432, 13.560, 0.254],
('f_t_shoulder_R(work)', 42) : [1.454, 13.366, 0.180],
('f_t_shoulder_R(work)', 46) : [1.462, 13.357, 0.078],
('f_t_shoulder_R(work)', 52) : [1.434, 13.630, -0.038],
('f_t_elbo_R(work)', 0) : [1.845, 11.430, -0.501],
('f_t_elbo_R(work)', 1) : [1.839, 11.418, -0.481],
('f_t_elbo_R(work)', 9) : [1.843, 11.105, -0.449],
('f_t_elbo_R(work)', 11) : [1.853, 11.029, -0.465],
('f_t_elbo_R(work)', 17) : [1.870, 11.080, -0.363],
('f_t_elbo_R(work)', 18) : [1.870, 11.109, -0.317],
('f_t_elbo_R(work)', 27) : [1.917, 11.394, 0.616],
('f_t_elbo_R(work)', 37) : [1.939, 11.152, 0.864],
('f_t_elbo_R(work)', 42) : [1.972, 10.944, 0.717],
('f_t_elbo_R(work)', 46) : [2.001, 10.908, 0.450],
('f_t_elbo_R(work)', 52) : [1.963, 11.152, -0.084],
('f_t_arm_R(work)', 0) : [2.395, 9.367, -0.054],
('f_t_arm_R(work)', 1) : [2.383, 9.341, -0.095],
('f_t_arm_R(work)', 9) : [2.409, 9.003, -0.311],
('f_t_arm_R(work)', 11) : [2.427, 8.928, -0.344],
('f_t_arm_R(work)', 17) : [2.423, 8.994, -0.049],
('f_t_arm_R(work)', 18) : [2.418, 9.029, 0.048],
('f_t_arm_R(work)', 27) : [2.441, 9.529, 1.618],
('f_t_arm_R(work)', 37) : [2.438, 9.361, 2.005],
('f_t_arm_R(work)', 42) : [2.494, 9.107, 1.772],
('f_t_arm_R(work)', 46) : [2.553, 8.992, 1.336],
('f_t_arm_R(work)', 52) : [2.531, 9.170, 0.628],
('f_t_thigh_R(work)', 0) : [0.820, 9.075, 0.048],
('f_t_thigh_R(work)', 1) : [0.820, 9.057, 0.054],
('f_t_thigh_R(work)', 9) : [0.818, 8.715, 0.091],
('f_t_thigh_R(work)', 11) : [0.817, 8.646, 0.091],
('f_t_thigh_R(work)', 17) : [0.818, 8.793, 0.060],
('f_t_thigh_R(work)', 18) : [0.818, 8.837, 0.055],
('f_t_thigh_R(work)', 27) : [0.820, 9.101, 0.029],
('f_t_thigh_R(work)', 37) : [0.819, 8.842, 0.001],
('f_t_thigh_R(work)', 42) : [0.819, 8.662, -0.035],
('f_t_thigh_R(work)', 46) : [0.819, 8.654, -0.057],
('f_t_thigh_R(work)', 52) : [0.820, 8.891, -0.036],
('f_t_knee_R(work)', 0) : [0.653, 5.937, 2.551],
('f_t_knee_R(work)', 1) : [0.615, 5.956, 2.601],
('f_t_knee_R(work)', 9) : [0.486, 5.387, 2.318],
('f_t_knee_R(work)', 11) : [0.514, 5.153, 2.053],
('f_t_knee_R(work)', 17) : [0.499, 5.217, 1.863],
('f_t_knee_R(work)', 18) : [0.510, 5.233, 1.805],
('f_t_knee_R(work)', 27) : [0.531, 5.167, 0.793],
('f_t_knee_R(work)', 37) : [0.562, 4.833, -0.035],
('f_t_knee_R(work)', 42) : [0.565, 4.712, -0.726],
('f_t_knee_R(work)', 46) : [0.617, 4.801, -1.181],
('f_t_knee_R(work)', 52) : [0.972, 4.876, -0.012],
('f_t_leg_R(work)', 0) : [1.029, 2.212, 0.095],
('f_t_leg_R(work)', 1) : [1.004, 1.994, 0.555],
('f_t_leg_R(work)', 9) : [0.316, 1.120, 3.659],
('f_t_leg_R(work)', 11) : [0.200, 1.021, 3.746],
('f_t_leg_R(work)', 17) : [0.077, 0.781, 2.300],
('f_t_leg_R(work)', 18) : [0.074, 0.787, 2.092],
('f_t_leg_R(work)', 27) : [0.031, 0.787, 0.016],
('f_t_leg_R(work)', 37) : [0.070, 0.783, -1.878],
('f_t_leg_R(work)', 42) : [0.114, 0.831, -2.912],
('f_t_leg_R(work)', 46) : [0.212, 1.186, -3.789],
('f_t_leg_R(work)', 52) : [0.552, 2.306, -3.653],
}

rotations={
('f_t_leg_L(work)', 0):  [0.014, -0.018, -0.009, -0.999], 
('f_t_leg_L(work)', 1):  [0.015, -0.017, -0.009, -0.999], 
('f_t_leg_L(work)', 9):  [0.008, -0.013, -0.013, -0.999], 
('f_t_leg_L(work)', 11): [0.008, 0.013, 0.015, 0.999], 
('f_t_leg_L(work)', 17): [0.366, 0.006, 0.060, 0.928], 
('f_t_leg_L(work)', 18): [0.428, 0.003, 0.079, 0.900], 
('f_t_leg_L(work)', 27): [0.398, -0.074, -0.079, 0.910], 
('f_t_leg_L(work)', 37): [0.180, -0.018, -0.023, -0.983], 
('f_t_leg_L(work)', 42): [-0.263, -0.008, 0.054, 0.963], 
('f_t_leg_L(work)', 46): [0.094, -0.008, -0.037, -0.994], 
('f_t_leg_L(work)', 52): [0.015, -0.017, -0.023, -0.999], 
('f_t_leg_R(work)', 0):  [0.269, 0.036, 0.056, 0.960], 
('f_t_leg_R(work)', 1):  [0.213, 0.023, 0.052, 0.975], 
('f_t_leg_R(work)', 9):  [-0.277, -0.010, -0.069, 0.958], 
('f_t_leg_R(work)', 11): [-0.301, 0.018, -0.079, 0.949], 
('f_t_leg_R(work)', 17): [-0.063, 0.029, -0.090, 0.993],
('f_t_leg_R(work)', 18): [-0.047, 0.031, -0.092, 0.994], 
('f_t_leg_R(work)', 27): [-0.013, 0.030, -0.026, 0.999], 
('f_t_leg_R(work)', 37): [-0.012, 0.033, -0.016, 0.999], 
('f_t_leg_R(work)', 42): [-0.011, -0.037, 0.020, -0.999], 
('f_t_leg_R(work)', 46): [-0.189, -0.042, 0.029, -0.980], 
...
def do_script():
	...
	# NOTE: posts to each stream go in strictly increasing order.  Posts to different streams don't need to be synchronized.
...
# PART 1
	...
	tff.post('bonePos f_t_leg_R(work)', 5.5, 1.03, 0.88, 0.45)
	tff.post('boneRot f_t_leg_R(work)', 5.5, 0.0)
	# adjust the knee 
	tff.post('bonePos f_t_knee_R(work)', 5.5, 3.6, 3.6, 3.6)
	# neck still straight
	tff.post('boneRot neck', 5.5, 0.0)
	
	# by 5.9 s, turn neck left 10 deg, up 15 deg
	tff.post('boneRot neck', 5.9, -10.0, -15.0)

	# by 6.0 s, body is still at heading 25 deg
	tff.post('rot', 6.0, 0.0, 25.0)
	
	# by 6.5 s, turn body to heading -125, tilt neck up 20
	tff.post('rot', 6.5, 0.0, -125.0)
	tff.post('boneRot neck', 6.5, -20.0)

	# simply rotating on the spot looks unrealistic, so we fine tune it by keeping  toes of the right foot in one place throughout the turn; 
	# we use the advanced mode editor to find where the foot should be, and we put it here.
	tff.post('bonePos f_t_leg_R(work)', 6.00, 1.13, 1.23, 0.91)
	tff.post('bonePos f_t_leg_R(work)', 6.21, 2.22, 1.38, -0.68)
	tff.post('bonePos f_t_leg_R(work)', 6.35, 1.82, 1.47, -1.99)

	tff.post('boneRot f_t_leg_R(work)', 6.35, 32., 0)

	tff.post('bonePos f_t_leg_R(work)', 6.68, -0.08, 1.47, -2.69)

	# by 6.8 s, turn body to heading -155 and tilt neck up 30
	tff.post('rot', 6.8, 0.0, -155.0)
	tff.post('boneRot neck', 6.8, -30.0)

	# by 7.2 s, bring the right foot back in place and turn it flat (same numbers as at the 5.5 s mark)
	tff.post('bonePos f_t_leg_R(work)', 7.2, 1.03, 0.88, 0.45)
	tff.post('boneRot f_t_leg_R(work)', 7.2, 0.0, 0)

	tff.post('boneRot hand_r', 7.2, 0.0, 0.0, -50.0)
...
# Move the right hand down until it is just above the mouth. 
	...
	#tff.post('bonePos f_t_elbo_R(work)', 9.0, 10.0, 11.0, 0.0)
