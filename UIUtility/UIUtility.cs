    ...
    public static class UIUtility
    {
        ...
        public static void Init()
        {
            if (_resourcesLoaded == false)
            {
                ...
                AssetBundle bundle = AssetBundle.LoadFromMemory(Properties.AI.Resources.DefaultResourcesHS);
                //AssetBundle bundle = AssetBundle.LoadFromMemory(Properties.HS.Resources.DefaultResources);
#endif
                var objects = bundle.LoadAllAssets<GameObject>(); 
                UnityEngine.Debug.LogError("Found objects: " + objects);
                foreach (GameObject obj in objects)
                    UnityEngine.Debug.LogError("Found object: " + obj);
                var sprites = bundle.LoadAllAssets<Sprite>();
                UnityEngine.Debug.LogError("Found sprites: " + sprites);
        ...
        private static ContextMenuUIElement GetContextMenuUIElement(int index)
        {
            ...
            UnityEngine.Debug.LogError("GetContextMenuUIElement " + index + _contextMenuElementPrefab);
